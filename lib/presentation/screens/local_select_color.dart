...
import 'package:sjekk_application/presentation/providers/local_violation_details_provider.dart';
...
class LocalSelectCarColorScreen extends StatefulWidget {
  static const String route = "LocalSelectCarColorScreen";
  const LocalSelectCarColorScreen({super.key});

  @override
  State<LocalSelectCarColorScreen> createState() => _LocalSelectCarColorScreenState();
}

class _LocalSelectCarColorScreenState extends State<LocalSelectCarColorScreen> {
  @override
  void initState() {
    super.initState();
    initializeColors();
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TemplateContainerCard(
                          ...
                          onTap: () async{
                            await context.read<LocalViolationDetailsProvider>().changeViolationColor(color);
