...
class LocalSelectCarTypeScreen extends StatefulWidget {
  static const String route = "LocalSelectCarTypeScreen";
  const LocalSelectCarTypeScreen({super.key});

  @override
  State<LocalSelectCarTypeScreen> createState() => _LocalSelectCarTypeScreenState();
}

class _LocalSelectCarTypeScreenState extends State<LocalSelectCarTypeScreen> {
  @override
  void initState() {
    super.initState();
    initializeTypes();
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TemplateContainerCard(
                          ...
                          onTap: () async{
                            await context.read<LocalViolationDetailsProvider>().changeViolationType(type);
